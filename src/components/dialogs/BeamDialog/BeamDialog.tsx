      ...
      footer={
        <>
          ...
          <div className="flex gap-2">
            ...
            <ModalButton onClick={handleDraw} variant="primary">
                  ...
                  {(mode === 'beam' || mode === 'sideview') ? (
                    <>
                      ...
                      <div className="mt-2 p-2 bg-cad-bg rounded text-[10px]">
                        ...
                        <span className="text-cad-text font-medium">
                          {`${formatNumber(concreteWidth, 0, unitSettings.numberFormat)} mm`}
                        </span>
                      </div>
                    </>
                  ) : (
                ...
                <div className="mt-4 pt-4 border-t border-cad-border space-y-3">
                  ...
                  {(mode === 'beam' || mode === 'sideview') ? (
                    <>
                      ...
                      <div className="mt-2 p-2 bg-cad-bg rounded text-[10px]">
                        <span className="text-cad-text-dim">Beam width in plan: </span>
                        <span className="text-cad-text font-medium">{formatNumber(flangeWidth, 1, unitSettings.numberFormat)} mm</span>
                      </div>
                    </>
                  ) : (
                    <>
                ...
                <div className="p-3 border-t border-cad-border">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-[10px]">
                    {preset.properties.area && (
                      <div className="flex justify-between">
                        <span className="text-cad-text-dim">Area:</span>
                        <span className="text-cad-text">{formatNumber(preset.properties.area, 0, unitSettings.numberFormat)} mm2</span>
                      </div>
                    )}
                    {preset.properties.weight && (
                      <div className="flex justify-between">
                    ...
                    {preset.properties.Ix && (
                      <div className="flex justify-between">
                        ...
                        <span className="text-cad-text">{formatNumber(preset.properties.Ix / 1e6, 2, unitSettings.numberFormat)}x10^6 mm4</span>
                      </div>
                    )}
                    {preset.properties.Iy && (
                      <div className="flex justify-between">
                        <span className="text-cad-text-dim">Iy:</span>
                        <span className="text-cad-text">{formatNumber(preset.properties.Iy / 1e6, 2, unitSettings.numberFormat)}x10^6 mm4</span>
                      </div>
                    )}
                  </div>
                </div>
