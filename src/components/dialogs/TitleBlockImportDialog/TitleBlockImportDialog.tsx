...
import { Upload, FileText, Check, AlertCircle, ChevronRight, ChevronLeft, Plus, Trash2 } from 'lucide-react';
...
const STEP_TITLES: Record<WizardStep, string> = {
  upload: 'Import Sheet Template - Upload',
  fields: 'Import Sheet Template - Fields',
  details: 'Import Sheet Template - Details',
  preview: 'Import Sheet Template - Preview',
};
...
export function TitleBlockImportDialog({ isOpen, onClose, onImportComplete }: TitleBlockImportDialogProps) {
    ...
    <>
      ...
      <div className="flex gap-2">
        ...
        {step !== 'preview' ? (
          ...
          <ModalButton onClick={handleImport} variant="primary">
            <span className="flex items-center gap-1">
              <Check size={12} />
              Import Template
            </span>
  ...
  return (
    <DraggableModal
      ...
      footerClassName="px-3 py-2 border-t border-cad-border flex justify-between"
    >
      {/* Progress Steps */}
